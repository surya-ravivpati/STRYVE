/**
 * STRYVE mark — the Y-spike, traced from the source logo art to a single path
 * so it stays crisp at any size and can be recoloured or animated.
 */
...
export default function Mark({ className = '', title, ...rest }: Props) {
  return (
    <svg
